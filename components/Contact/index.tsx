...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section id="support" className="px-4 py-[50px] md:px-8 2xl:px-0 ">
        <motion.div
          variants={{
            hidden: {
              opacity: 0,
          ...
          viewport={{ once: true }}
          className="flex justify-center gap-y-[80px] gap-[15px] pt-[100px]"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex  justify-center gap-[120px] px-[0px] sm:px-[18px] lg:py-[10px] py-[80px] "
        >
          <div
            className=" w-full sm:w-[80%] rounded-2xl bg-white px-[10px] py-[40px]	sm:px-[40px] shadow-xl"
            style={{ backgroundColor: "rgb(101 108 97 / 68%)" }}
          >
            <div className="">
              <h1 className="text-[18px] text-black">Hours:</h1>

              <div className=" text-[18px] text-black">
                <ul className="pt-[20px] text-black">
                  <li className="flex sm:gap-[50px] gap-[8px] text-black ">
                    <div className="text-black">Monday - Friday - </div>
                    <div>9 AM - 5 PM</div>
                  </li>
                  <li className="flex sm:gap-[110px] gap-[8px]">
                    <div>Saturday - </div>
                    <div>By Appointment</div>
                  </li>
                  <li className="flex sm:gap-[125px] gap-[8px]">
                    <div>Sunday - </div>
                    <div>Closed</div>
                  </li>
                </ul>
