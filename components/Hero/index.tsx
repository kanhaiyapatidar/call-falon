...
const Hero = () => {
  ...
  return (
    <>
     ...
     is our customer's  
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-titlebg dark:before:bg-titlebgdark ml-5">
                 loyalty
                </span>
              </h1>
              <p>
